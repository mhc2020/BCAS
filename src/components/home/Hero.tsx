      ...
      <div className="grid gap-6 rounded-2xl bg-gradient-to-r from-green-600 via-green-500 to-green-200 p-6 text-white shadow-sm md:grid-cols-2 md:items-center">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-green-50/95 md:text-base">
            Building a strong, welcoming Bangladeshi community in Saskatchewan
            through culture, events, and support.
          </p>
        ...
        <div className="rounded-2xl bg-white/15 p-5 backdrop-blur">
          ...
          {nextEvent ? (
            ...
            <p className="mt-2 text-green-50/90 text-sm">
              Stay tuned for our upcoming cultural and social programs.
            </p>
          )}
          <Link to="/events" className="mt-3 block text-xs font-bold underline">
            See all events
          </Link>
        </div>
      </div>
